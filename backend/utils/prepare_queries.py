...
class QueryPreparer:
    ...
    def prepare_queries(self,db_name):
        ...
        if customer_id and db_name=='oms' :
            ...
            queries.append(('ar1_account', query2))
            queries.append(('ar1_payment_details', query3))
            queries.append(('ar1_customer_credit', query4))
            queries.append(('ar1_charges', query5))
            queries.append(('AR3_ORDER_REFERENCE', query6))
